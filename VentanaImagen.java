...
public class VentanaImagen extends JFrame {
    ...
    public VentanaImagen(String title) throws HeadlessException {
        super(title);
        setSize(800,600);
        ...
        BotonPanel1.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                etiquetaPanel1.setText("Hey, presionaste el boton del panel 1");
            }
        });
        ...
        //Panel 2
        String urlImagen = "https://i.pinimg.com/474x/e9/92/74/e99274ef651c8577db43fcc92b2e79a9--leon-s-kennedy.jpg";
        panel2 = new JPanel();
        ...
        try{
            ...
            System.out.println("Eror al cargar la imagen");
        }
